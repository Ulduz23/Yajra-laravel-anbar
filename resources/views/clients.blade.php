...
<div class="container mt-4">
  ...
  <div><a class="col-md-12 mt-1 mb-2" href="/cexport">EXCEL</a></div>
          ...
          <div class="modal-body">
            <form action="javascript:void(0)" id="addEditBookForm" name="addEditBookForm" class="form-horizontal" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" id="client" name="client" placeholder="Enter Name" maxlength="50" required="">
                </div>
              </div>  
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" id="soyad" name="soyad" placeholder="Enter Soyad" maxlength="50" required="">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" id="telefon" name="telefon" placeholder="Enter Telefon" required="">
                </div>
              </div>    
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" id="sirket" name="sirket" placeholder="Enter Sirket" required="">
                </div>
              </div>                  
