        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2">Qeydiyyatdan kecin 🚀</h4>
...
@endif
              ...
              <form id="formAuthentication" class="mb-3" action="{{route('register')}}" method="POST">
                ...
                <input type="text" class="form-control" name="surname" placeholder="Enter your surname"autofocus />
                </div>

                <div class="mb-3">
                  <label for="telefon" class="form-label">Telefon</label>
                  <input type="text" class="form-control" name="telefon" placeholder="Enter your phone"autofocus />
                </div>
                ...
                <a href="{{route('register')}}"><button class="btn btn-primary d-grid w-100">Sign up</button></a>
              </form>
